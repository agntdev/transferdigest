...
const HELP =
  "Use the menu to view today’s transfers, choose a date, and manage daily summaries.\n\n" +
  "You can also send a date or transfer reference when the bot asks for one.";
